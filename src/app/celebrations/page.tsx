    ...
    <section className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-6 mb-16">
        ...
        <motion.h2
          ...
          className="text-4xl sm:text-5xl font-bold text-[#1f1f20] text-center mb-12"
        >
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <motion.div
            ...
            className="space-y-6"
          >
            <h3 className="text-2xl font-semibold text-[#010101]">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              precision. No detail is left untouched. We ensure all logistics,
              décor, and management elements are handled with world-class
              execution.
            </p>
