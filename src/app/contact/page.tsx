  ...
  return (
    <section className="bg-[#fffaf4]">
      ...
      <div className="max-w-5xl mx-auto px-6 py-16 text-center">
        <h2 className="text-2xl md:text-3xl font-serif text-[#b8846b] mb-4">
          “Do You Need A Wedding Planner, Event Planner Or Event Designer?”
        </h2>

        <p className="text-[#6b4b3a] text-lg max-w-3xl mx-auto leading-relaxed mb-6">
          Provide us with your event needs below.
        </p>

        <p className="text-[#6b4b3a] text-lg font-light">
          Do You Want A Picture Perfect Wedding Day?
        </p>

        <p className="mt-4 text-[#6b4b3a] text-lg">
          Are You Ready For A Wedding That Will Exceed Expectations?
        </p>

        <p className="mt-4 text-[#6b4b3a] text-lg font-medium italic">
          “We Will Make Your Vision a Reality”
        </p>

        <p className="mt-4 text-[#6b4b3a] text-lg font-medium">
      ...
      <div className="max-w-4xl mx-auto px-6 mb-16">
        <div className="bg-white/80 backdrop-blur-xl shadow-xl border border-[#efd8bd] rounded-3xl p-8 text-center">
          <h3 className="text-xl font-semibold text-[#b8846b] mb-2">Contact Information</h3>

          <p className="text-[#6b4b3a] text-lg">Phone: (561) 574-1246</p>

          <p className="text-[#6b4b3a] mt-4">
          ...
          <p className="text-[#6b4b3a] mt-4 italic">
      ...
      <div className="max-w-5xl mx-auto px-6 pb-24">
        <h3 className="text-center text-3xl font-serif text-[#b8846b] mb-10">
          Receive Your Free Wedding & Special Event Consultation
        </h3>

        <div className="bg-white rounded-3xl p-10 shadow-xl border border-[#efd8bd] backdrop-blur-xl">
          <form className="grid md:grid-cols-2 gap-6">
            {/* Input */}
            <input
              type="text"
              placeholder="Full Name"
              className="w-full p-4 rounded-xl border border-[#d7c7b3] bg-white text-[#6b4b3a] 
            ...
            <textarea
              ...
              className="md:col-span-2 w-full p-4 rounded-xl border border-[#d7c7b3] bg-white text-[#6b4b3a] 
              focus:outline-none focus:ring-2 focus:ring-[#b8846b] h-32"
            />

            {/* Button */}
            <button
              className="md:col-span-2 bg-[#b8846b] hover:bg-[#a3735a] text-white text-lg py-4 rounded-xl transition"
            >
