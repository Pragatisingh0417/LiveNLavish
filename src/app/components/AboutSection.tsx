...
export default function AboutSection() {
  return (
    <section className="relative bg-gradient-to-b from-[#fffaf5] via-[#fffdfb] to-[#ffffff] py-16 sm:py-20 md:py-10 overflow-hidden">
      <div className="max-w-[1300px] mx-auto px-4 sm:px-6 lg:px-10 flex flex-col md:flex-row items-center gap-10 md:gap-16">
        ...
        >
          ...
          >
            <Link
              href="/about"
              className="inline-block bg-[#B98B4E] text-white px-6 sm:px-8 py-3 rounded-full shadow-lg hover:bg-[#c08e4c] transition-all duration-300 text-sm sm:text-base"
            >
              Learn More
            </Link>
          </motion.div>
      ...
      >
        <Image
          src="/images/a_make_the_colour_of_l (1).png"
          alt="Decorative leaf"
          width={350}
          height={350}
          className="w-[180px] sm:w-[250px] lg:w-[350px]"
        />
      </motion.div>
    </section>
  );
