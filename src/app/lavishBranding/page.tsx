  ...
  return (
    <section className=" bg-[#fffdf7]">
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        {/* FORM SECTION */}
        <div 
        className="bg-white/70 p-8 rounded-3xl shadow-lg border border-white/40 mb-20 backdrop-blur-lg">
...
<textarea
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          ...
          <motion.div
            ...
            transition={{ duration: 0.7 }}
            className="rounded-3xl overflow-hidden shadow-xl border border-white/40"
          >
            <Image
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-14">
          {highlights.map((text, index) => (
            <motion.div
              ...
              className="p-6 bg-white/70 text-black border border-white/40 rounded-2xl shadow-lg"
            >
              ✦ {text}
            </motion.div>
          ))}
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-14 text-black">
          <div className="stat-card">10,000+ Physical & Digital Copies Distributed / Quarter</div>
          <div className="stat-card">Avg Viewer Age: 25–65 Years Old</div>
